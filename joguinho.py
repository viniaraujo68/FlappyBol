...
def load():
    ...
    menu_img = pygame.image.load("joguinho\\menu.png")
    menu_img = transform.scale(menu_img,(1350, 756))
    over_img = pygame.image.load("joguinho\\game_over.png")
    over_img = transform.scale(over_img,(1350, 756))
    pipe_img = pygame.image.load("joguinho\\pipe.png")
    pipe_img = transform.scale(pipe_img,(596,610))
    rafa = pygame.image.load("joguinho\\rafap.png")
    fleu = pygame.image.load("joguinho\\fleury.png")
    ...
    bol1 = pygame.image.load("joguinho\\bol.png")
    bol = transform.scale(bol1,(r_bird*ref[0][0],r_bird*ref[0][1]))
    baffa = pygame.image.load("joguinho\\boss.png")
    title =  pygame.image.load("joguinho\\titulo.png")
    nome_bol =  pygame.image.load("joguinho\\bolnome.png")
    nome_fleu =  pygame.image.load("joguinho\\fleurynome.png")
    nome_rafa = pygame.image.load("joguinho\\rafanome.png")
    nome_over = pygame.image.load("joguinho\\overnome.png")
    bg = pygame.image.load("joguinho\\fundo.png")
    bg = transform.scale(bg,(1350,756))
    pygame.mixer.music.load('joguinho\\tema_menu.mp3')
    death_sound = pygame.mixer.Sound("joguinho\\eren.mp3")
    clock = Clock()
...
def change_music():
    ...
    if menu:
        ...
        pygame.mixer.music.load('joguinho\\naruto_fight.mp3')
    else:
        pygame.mixer.music.set_volume(0.2)
        pygame.mixer.music.load('joguinho\\lacrimosa.mp3')
